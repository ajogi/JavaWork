...
class Bank {
	...
	public void transaction() 
	{
		...
		System.out.println("Transaction Amount :Rs." + trans_amount);
		System.out.println("Balance Amount:Rs."+ bal_amount);
		System.out.println("Interest Amount: Rs."+interest_amount);
